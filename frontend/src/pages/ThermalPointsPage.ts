...
.tp-picker-wrap img { display: block; width: 100%; height: auto; pointer-events: none; }
...
.tp-picker-tabs { display: flex; gap: 0; margin-bottom: 8px; border-bottom: 1px solid #1e293b; }
...
<tr>
  ...
  <td style="display:flex;gap:6px">
    ...
    private updatePickerTab(): void {
        ...
        img.src = isThermal ? thermalSrc : opticalSrc;
    ...
    private bindEvents(): void {
        ...
        document.getElementById('tpPickerWrap')?.addEventListener('click', (e) => {
