...
nonallow list        public const int MINOR_EMPLOYEENO_AND_FP_VERIFY_TIMEOUT = 0x47; // employee and finger print verify timeout 
        ...
        public const int MINOR_CERTIFICATE_BLACK_LIST = 0x71; // nonallow list 
        ...
        public struct NET_DVR_ACS_EVENT_INFO
        {
            ...
            public byte byCardType; // card type,1-ordinary card,2-disable card,3-nonallow list card, 4-patrol card,5-stress card,6-super card,7-client card, 0 means invalid
        ...
        public struct NET_DVR_CARD_CFG_V50
        {
            ...
            public byte byCardType; //card type ,1-ordinary card,2-disabled card,3-nonallow list card, 4-patrol card,5-stress card,6-super card,7-guest card,8-remove card, 9-employee card,10-emergency card,11-emergency management card,default ordinary card 
