...
namespace PlanTemplate
{
    ...
    public class AcsDemoPublic
    {
        ...
        public static readonly string[] strCardType = { "unknown", "ordinary card", "disabled card", "nonallow list card", "patrol card", "stress card", "super card", "guest card", "remove card", 
